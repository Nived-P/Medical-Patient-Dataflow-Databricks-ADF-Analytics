...
> ⚠️ Files with real credentials (`*_local.py`) are gitignored. All secrets stored in Azure Key Vault and referenced via `dbutils.secrets.get()`.
...
[GitHub](https://github.com/Nived-P) · [LinkedIn](https://www.linkedin.com/in/nived-p-59a480213/)