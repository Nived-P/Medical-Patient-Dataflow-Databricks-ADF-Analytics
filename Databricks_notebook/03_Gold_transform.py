...
gold_dim_patient = "abfss://gold@hospadbstorageaccount.dfs.core.windows.net/dim_patient"
gold_dim_department = "abfss://gold@hospadbstorageaccount.dfs.core.windows.net/dim_department"
gold_fact = "abfss://gold@hospadbstorageaccount.dfs.core.windows.net/fact_admissions"
